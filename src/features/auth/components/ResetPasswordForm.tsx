...
const ResetPasswordForm = () => {
  ...
  if (accessToken) {
    return (
      <>
        <div className="min-h-21.25 flex justify-center items-center overflow-y-auto px-4">
          <form
            className="formStyle w-full max-w-xl px-5 md:px-7 md:bg-white"
            onSubmit={handleSubmit(createNewPassword)}
          >
            <div className="w-full md:w-[90%] mx-auto">
              <div className=" md:mb-4 w-full ">
                <h1 className="w-full text-[24px] font-semibold pt-5">
              ...
              <div className="flex flex-col pt-5 gap-2 mb-4 w-full">
              ...
              <button
                ...
                className="btn btn-primaryy disabled:cursor-not-allowed text-[16px] font-medium w-full mt-2 mb-7"
              >
