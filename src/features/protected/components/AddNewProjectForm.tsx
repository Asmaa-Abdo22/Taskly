        ...
        >
          ...
          <div className="inputs">
            ...
            <textarea
              ...
              name="description"
              id="description"
              className="w-full placeholder:text-slate-600/50 placeholder:text-[16px] px-3 py-2 text-body-md text-slate-900 bg-surface-highest border-transparent rounded-md focus:outline-none focus:ring-1 focus:ring-primaryy/50 transition-colors resize-none h-37"
